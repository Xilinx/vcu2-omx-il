...
readonly external_srcs="$(pwd)/../allegro-vcu2-ctrl-sw"
readonly external_libs="$external_srcs/bin"
readonly external_includes="$(pwd)/../allegro-vcu2-ctrl-sw/include"
readonly external_configs="$(pwd)/../allegro-vcu2-ctrl-sw/include/config.h"
