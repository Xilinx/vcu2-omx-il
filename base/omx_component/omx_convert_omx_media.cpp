...
OMX_COLOR_FORMATTYPE ConvertMediaToOMXFormat(Format format)
{
  ...
  case StorageType::STORAGE_RASTER:
  {
    ...
    case 10:
    {
      switch(format.color)
      {
      case ColorType::COLOR_400: return static_cast<OMX_COLOR_FORMATTYPE>(OMX_ALG_COLOR_FormatL10bit);
      case ColorType::COLOR_420: return static_cast<OMX_COLOR_FORMATTYPE>(OMX_ALG_COLOR_FormatYUV420SemiPlanar10bit);
      case ColorType::COLOR_422: return static_cast<OMX_COLOR_FORMATTYPE>(OMX_ALG_COLOR_FormatYUV422SemiPlanar10bit);
      case ColorType::COLOR_444: return static_cast<OMX_COLOR_FORMATTYPE>(OMX_ALG_COLOR_FormatYUV444Planar10bit);
      case ColorType::COLOR_MAX_ENUM: return OMX_COLOR_FormatMax;
      default:
        throw invalid_argument("format.color");
      }
